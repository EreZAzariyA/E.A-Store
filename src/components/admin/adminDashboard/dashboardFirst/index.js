...
export const DashboardFirst = () => {
  ...
  // https://s3.eu-central-1.amazonaws.com/e.a-store/icons/dollar-coin.svg
  ...
  return (
    ...
    >
        ...
        <Row align={'top'} gutter={[10, 0]}>
          ...
          <Col span={6}>
            <div className="symbol-box coin">
              <img src={'https://s3.eu-central-1.amazonaws.com/e.a-store/icons/dollar-coin.svg'} alt="coin" />
            </div>
          </Col>
        </Row>
      </Col>
      ...
      <Col className="tag">b</Col>
      <Col className="tag">c</Col>
      <Col className="tag">d</Col>
    </Row>
  );
};